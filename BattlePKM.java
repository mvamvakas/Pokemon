...
public class BattlePKM extends Pokemon {
    ...
    /**
     * Function: Shows the battle status of a pokemon
     * @return 
     */
    public String status(){
        return this.getPokemonNickname() + " " + this.getCurrHP() + "/" + this.getHP() + "hp";
    }
    
    /**
     * Function: Checks to see if the pokemon has fainted
     * @return 
     */
