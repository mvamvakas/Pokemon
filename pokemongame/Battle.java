...
public class Battle {
    ...
    public boolean runBattle() {
        ...
        if (choice.equals(ally.getSlotA().getName())){
            takeDMG(opponentPokemon, calculateDamage(ally, opponentPokemon, ally.getSlotA()));
            moveEffects(ally, opponentPokemon, ally.getSlotA());
        }
        else if (choice.equals(ally.getSlotB().getName())){
            takeDMG(opponentPokemon, calculateDamage(ally, opponentPokemon, ally.getSlotB()));
            moveEffects(ally, opponentPokemon, ally.getSlotB());
        }
        else if (choice.equals(ally.getSlotC().getName())){
            takeDMG(opponentPokemon, calculateDamage(ally, opponentPokemon, ally.getSlotC()));
            moveEffects(ally, opponentPokemon, ally.getSlotC());
        }
        else if (choice.equals(ally.getSlotD().getName())){
            takeDMG(opponentPokemon, calculateDamage(ally, opponentPokemon, ally.getSlotD()));
            moveEffects(ally, opponentPokemon, ally.getSlotD());
        }
    ...
    private String takeDMG(BattlePKM pokemon, Double damage){
        ...
        str = pokemon.getPokemonNickname() + " took " + damage.intValue() + "/n";
