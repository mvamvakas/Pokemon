...
public class Game {
    ...
    public void run() {
        ...
        try {
            ...
            pkm = new BattlePKM("Pikachu", "Pokebro", "Electric", "Steel", moveMap.get("Absorb"), moveMap.get("Agility"), moveMap.get("None"), moveMap.get("None"), 5, 50, 15, 5, 5, 5, 5);
            pkm2 = new BattlePKM("Mudkip", "Mudkip", "Water", "None", moveMap.get("Absorb"), moveMap.get("Agility"), moveMap.get("None"), moveMap.get("None"), 5, 50, 5, 5, 5, 5, 5);
        } 
